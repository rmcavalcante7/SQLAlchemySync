...
if __name__ == '__main__':
    try:
        insertRevendedor(nome='Sorbato de Potássio', cnpj='12345678901234', razao_social='Sorbato de Potássio LTDA',
                         contato='Sorbato de Potássio')
    except Exception as e:
        print(f'Erro ao inserir Revendedor: {e}')

    try:
        insertRevendedor(nome='Benzoato de Sódio', cnpj='12345678901234', razao_social='Benzoato de Sódio LTDA',
