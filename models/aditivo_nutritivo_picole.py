...
def selectAllAditivoNutritivoPicole():
...
def selectAllAdiNutPicPorPicoleFK(picole_fk: int) -> list or []:
...
def selectAllAdiNutPicPorAditivoFK(aditivo_nutritivo_fk: int) -> list or []:
    """Seleciona todos os AditivoNutritivoPicole na tabela aditivo_nutritivo_picole
    :param aditivo_nutritivo_fk: int: id do aditivo nutritivo
...
if __name__ == '__main__':
    ...
    try:
        insertAditivoNutritivoPicole(picole_fk=2, aditivo_nutritivo_fk=2)
    except Exception as e:
        print(f'Erro ao inserir AditivoNutritivoPicole: {e}')
