...
#
# import tests.conf.test_db_session
#
# # Execute os testes
# pytest.main()
#
# # Verifique se todos os testes passaram
# if pytest.ExitCode.OK in pytest.main():
...
#
#
# # rodar no terminal python run_tests.py
# # mudar para o diretório  C:\Users\rafael.m.cavalcante\PycharmProjects\SQLAlchemy\SQLAlchemySync\tests>
